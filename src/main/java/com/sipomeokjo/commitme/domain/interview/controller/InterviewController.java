...
public class InterviewController {
    ...
    @GetMapping
    public ResponseEntity<APIResponse<List<InterviewResponse>>> getInterviews(@CurrentUserId Long userId) {
    ...
    public ResponseEntity<APIResponse<InterviewResponse>> updateInterviewName(
        ...
        InterviewResponse interview = interviewCommandService.updateName(userId, interviewId, request);
