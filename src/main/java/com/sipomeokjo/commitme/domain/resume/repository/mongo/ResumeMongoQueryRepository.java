...
public class ResumeMongoQueryRepository {
    ...
    /**
     * Atomically clears has_unseen_preview if set. Returns the updated document (after
     * modification) if it was present and cleared, otherwise empty.
     */
    public Optional<ResumeDocument> clearUnseenPreviewIfPresent(Long resumeId) {
        Query query =
                Query.query(
                        Criteria.where("resume_id")
                                .is(resumeId)
